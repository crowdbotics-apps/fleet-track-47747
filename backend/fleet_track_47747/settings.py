"""
Django settings for fleet_track_47747 project.
...
ROOT_URLCONF = 'fleet_track_47747.urls'
...
WSGI_APPLICATION = 'fleet_track_47747.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fleet_track_47747 API",
    "DESCRIPTION": "API documentation for fleet_track_47747 App",
    "VERSION": "v1",
}
